...
export default function InstagramCollage() {
  ...
  return (
    <section className="py-20 overflow-hidden">
      <div 
        ref={titleRef}
        className={`px-6 mb-10 flex items-end justify-between transition-all duration-700 ${
      ...
      >
        ...
        <a
          ...
          className="flex items-center gap-2 text-[12px] text-[#8e7f74] hover:text-[#c8a27b] transition-colors"
        >
          @lilook51
      ...
      <div className="relative px-4">
        ...
        <div className="grid grid-cols-12 gap-2 md:gap-3 auto-rows-[120px] md:auto-rows-[150px]">
          ...
          <div className="col-span-4 row-span-2 bg-[#2e1e0f] rounded-[20px] flex flex-col items-center justify-center p-4 text-center">
            ...
            <p className="font-cormorant text-[18px] text-white font-medium mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Rejoignez-nous
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-2 bg-white/10 border border-white/20 rounded-full text-[11px] text-white tracking-wide hover:bg-white/20 transition-colors"
            >
              Suivre
            </a>
          </div>
...
function CollageImage({ 
  ...
  const gridClasses: Record<string, string> = {
    ...
    wide: 'col-span-5 row-span-1',
    square: 'col-span-3 row-span-1',
  }

  return (
    <div
      ref={ref}
      className={`${gridClasses[image.size]} rounded-[16px] overflow-hidden group transition-all duration-700 ${
