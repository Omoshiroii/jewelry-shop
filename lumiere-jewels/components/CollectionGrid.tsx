...
function CollectionCard({ 
  ...
  return (
    <div
      ref={ref}
      className={`relative overflow-hidden rounded-[24px] group cursor-pointer transition-all duration-700 ${
    ...
    >
      <Link href={collection.href} className="block w-full h-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <h3 
            className="font-cormorant text-[1.8rem] text-white font-medium mb-1"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            {collection.title}
          </h3>
